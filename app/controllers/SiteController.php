...
//require_once dirname(__FILE__).'/../library/OAuthHelpers.php';
class SiteController extends BaseController
{
    ...
    public function getNoAccess(){
        $this->layout->nest('content',$this->viewPrefix . 'site.noaccess',array());
    }

    public function getIndex(){
        $newComments = Comment::with('user')->orderBy('created_at','desc')->limit(10)->get();
        $this->layout->nest('content',$this->viewPrefix . 'site.index',array('newComments'=>$newComments));
    }
