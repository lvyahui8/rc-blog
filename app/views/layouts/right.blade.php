<section id="top_header">
    ...
    <div class="component top_links contact-link">
        ...
        <a target="_blank" href="http://www.cnblogs.com/lvyahui/" title="博客园"><img src="http://www.cnblogs.com/favicon.ico"></a>
    ...
    <div class="component top_news list-panel post-list">
        ...
        <div class="flexcroll list-body ">
            <ul class="list">
                ...
                <li class="list-item"><a class="list-item-title" title="{{$post->title}}" href="{{URL::to('blog/view/'.$post->id)}}" target="contentFrame">{{$post->title}}</a></li>
                @endforeach
            </ul>
        </div>
    </div>
    <div class="component right-footer">
        <nav id="footer-nav">
            <ul>
                <li><a target="_blank" href="http://gringuy.com">Snoopy</a></li>
                <li><a target="_blank" href="http://liangzhonghe.com">游龙戏鹤</a></li>
                <li><a target="_blank" href="http://code.taobao.org/u/lvyahui/mypro/">TaoCode</a></li>
            </ul>
        </nav>
        <p id="copy">Copyright &copy; 2014-2017 lvyahui. All Rights Reserved.</p>
    </div>
</section>